...
{
    public class BlazDialogService : IDisposable
    {
        private DotNetObjectReference<BlazDialogService> reference;
        internal DotNetObjectReference<BlazDialogService> Reference
        {
            get
            {
                if (reference == null)
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlazDialogService"/> class.
        /// </summary>
        /// <param name="uriHelper">The URI helper.</param>
        /// <param name="jsRuntime">IJSRuntime instance.</param>
        public BlazDialogService(NavigationManager uriHelper, IJSRuntime jsRuntime)
        {
            UriHelper = uriHelper;
            JSRuntime = jsRuntime;
        ...
        /// <param name="options">The dialog options.</param>
        /// <returns>The value passed as argument to <see cref="Close" />.</returns>
        public Task<dynamic> OpenAsync(string title, RenderFragment<BlazDialogService> childContent, DialogOptions options = null)
        {
            var task = new TaskCompletionSource<dynamic>();
            tasks.Add(task);
        ...
        /// <param name="childContent">The content displayed in the dialog.</param>
        /// <param name="options">The dialog options.</param>
        public void Open(string title, RenderFragment<BlazDialogService> childContent, DialogOptions options = null)
        {
            options = options ?? new DialogOptions();
        ...
        public async Task<bool?> Confirm(string message = "Confirm?", string title = "Confirm", ConfirmOptions options = null)
        {
            ...
            return await OpenAsync(title, ds =>
            {
                RenderFragment content = b =>
                {
                    ...
                    b.OpenComponent<BlazorScheduler.Components.BlazButton>(i++);
                    ...
                    b.AddAttribute(i++, "ButtonStyle", BlazorScheduler.Components.ButtonStyle.Secondary);
    ...
    public class DialogOptions
    {
        ...
        public RenderFragment<BlazDialogService> ChildContent { get; set; }
        /// <summary>
