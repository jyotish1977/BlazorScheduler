...
{
    public class BlazComponent : ComponentBase, IDisposable
    {
        /// <summary>
        ...
        private DotNetObjectReference<BlazComponent> reference;

        /// <summary>
        /// Gets the reference for the current component.
        /// </summary>
        /// <value>The reference.</value>
        protected DotNetObjectReference<BlazComponent> Reference
        {
            get
            {
                if (reference == null)
