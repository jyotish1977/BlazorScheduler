...
namespace BlazorScheduler.Components
{
    ...
    public interface BlazCommon
    {
        ...
        void AddItem(BlazSelectBarItem item);

        /// <summary>
        /// Removes the specified item from the select bar.
        /// </summary>
        /// <param name="item">The item.</param>
        void RemoveItem(BlazSelectBarItem item);
    ...
    /// </summary>
    public class RadzenComponentWithChildren : BlazComponent
    {
        /// <summary>
